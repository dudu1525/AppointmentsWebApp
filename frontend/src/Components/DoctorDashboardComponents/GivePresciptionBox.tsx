...
const GivePresciptionBox = (props: Props) => {
...
const handleSubmit = async (e: React.MouseEvent<HTMLButtonElement>) => {
 ...
 const renderWindow = () =>  {
    ...
    return(
      ...
      <div className="flex flex-col gap-2 min-h-[200px] h-140 overflow-y-auto">
        {renderWindow()}
      </div>
    </div>
  );
...
export default GivePresciptionBox